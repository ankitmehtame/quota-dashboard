...
`https://ollama.com/api/usage`; session windows follow the Monday 00:00 UTC daily
schedule (`00:00`, `04:00`, `09:00`, `14:00`, and
`19:00`), and weekly windows reset each Monday at 00:00 UTC.
